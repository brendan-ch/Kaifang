...
struct ArticleRepositoryTests {
    ...
    func getSampleArticles() -> [Article] {
        ...
        // dateCreated/dateModified must be DISTINCT across articles so the date-based sort tests
        ...
        let createdOffsets: [TimeInterval] = [-5.0, -4.0, -3.0, -2.0, -1.0]
        let modifiedOffsets: [TimeInterval] = [-0.004, -0.003, -0.002, -0.001, 0.000]
